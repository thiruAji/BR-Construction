 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wo="server_timestamp",vo="__type__",_o="__previous_value__",Eo="__local_write_time__";function To(e){const t=(e?.mapValue?.fields||{})[vo]?.stringValue;return t===wo}function Io(e){const t=e.mapValue.fields[_o];return To(t)?Io(t):t}function bo(e){const t=mo(e.mapValue.fields[Eo].timestampValue);return new qi(t.seconds,t.nanos)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
